...
import com.edervinicius.workshopmongo.dto.AuthorDTO;
import com.edervinicius.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um otimo!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
